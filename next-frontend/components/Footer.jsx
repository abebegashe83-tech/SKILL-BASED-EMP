...
export default function Footer() {
  ...
  const linkClass = (path) =>
    `transition-colors ${isActive(path) ? 'text-blue-400 font-semibold' : 'hover:text-white'}`;

  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-300 py-12 transition-colors">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm">
              AI-powered job matching platform connecting talent with opportunities based on skills, not degrees.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="text-gray-500 hover:text-blue-400 dark:text-gray-400 dark:hover:text-blue-300 transition-colors">
                <IconTwitter />
              </a>
              <a href="#" className="text-gray-500 hover:text-blue-700 dark:text-gray-400 dark:hover:text-blue-500 transition-colors">
                <IconLinkedIn />
              </a>
